...
var system_alerts = function(client,mysql_con){
	
	client.on("update_admin_alerts",function(objAdminAlerts){
		
		objAdminAlerts = JSON.parse(objAdminAlerts);
		system_alerts_da.updateAdminAlerts(client,mysql_con,objAdminAlerts.username,objAdminAlerts.alert_type,objAdminAlerts.alert_value);
